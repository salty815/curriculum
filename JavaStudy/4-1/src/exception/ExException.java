...
public class ExException {
            ...
            try {
                ...
                switch (parameter) {
                    ...
                    case CONST_EXCEPTION_TRIGER_ARRAY_OUT_OF_BOUNDS:
                        ...
                        // ここへ記述
                        int[] arrayException = {1, 2, 3};
                        checkNumber(arrayException);
                        break;
     ...
     */
    // ここへ記述
    private static void checkWorkation(String workationName) throws NullPointerException {
        if(workationName.equals("Shinbashi")) {
            System.out.println("やめとけ、混んでる");
        } else if(workationName.equals("Shibuya")) {
            System.out.println("意外とおしゃれ");
        }
    }

    private static void checkNumber(int[] array) throws ArrayIndexOutOfBoundsException {
        if(array[10] == 10) {
            System.out.println("数値あってます");    
        }
    }
    /**
     * 例外処理のメッセージを出力
